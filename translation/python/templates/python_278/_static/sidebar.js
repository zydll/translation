...
$(function() {
  ...
  function scroll_sidebar() {
    ...
    var max_height = $('.documentwrapper').height() + $('.documentwrapper').position()['top'] - sidebar_height - 300;
    ...
    if (sidebar_height < viewport_height) {
      ...
      if (curtop > wintop && curbot > winbot) {
        sidebarwrapper.css('top', $u.min([$u.max([wintop - offset - 10, 0]), 
                              max_height]));
      }
    ...
    if (curtop >= max_height) {
        $("#sidebarbutton span").css({
            'display': 'block',
            'position': 'relative',
            'margin-top': max_height + sidebar_height / 2
        });
    } else {
        $("#sidebarbutton span").css({
            'display': 'block',
